...
public class TsEmojiList extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		((Button) findViewById(R.id.buttonSubmit)).setOnClickListener(mSubmitListener);
...
//                Toast.makeText(TsEmojiList.this, "" + position, Toast.LENGTH_SHORT).show();
//			}
//        });
	...
	OnClickListener mSubmitListener = new OnClickListener() {
		public void onClick(View v) {
			Toast.makeText(TsEmojiList.this, mEmojiString.toString(), Toast.LENGTH_SHORT).show();
			finish();
		}
	};
    ...
    OnItemClickListener mItenClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
			if (mEmojiString.size() < 20) {
				...
				// TODO: •¶Žš—ñƒŠƒ\[ƒX‰»
				Toast.makeText(TsEmojiList.this, "‚±‚êˆÈã‚ÍŠ¨•Ù‚µ‚Ä‰º‚³‚¢", Toast.LENGTH_SHORT).show();
			}
		}
    };
